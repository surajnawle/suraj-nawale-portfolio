          ...
          <div className="max-w-7xl mx-auto w-full relative z-10">
            <div className="max-w-6xl relative">
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-24">
                ...
                <a href="https://surajnawle.github.io/suraj-nawale-portfolio/resume.pdf" target="_blank" className="px-12 py-5 border border-white/10 hover:border-emerald-500/50 text-white text-[11px] font-black rounded-sm transition-all text-center uppercase tracking-[0.2em] bg-white/5 flex items-center justify-center gap-3 group">
